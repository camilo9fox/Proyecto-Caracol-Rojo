"""
Django settings for caracol_rojo project.
...
SECRET_KEY = 'c8j=^3g_cbm*djex+z7kx6zjz^1$s79(6=iq9yt6v#1&esoio7'
...
ROOT_URLCONF = 'caracol_rojo.urls'
...
WSGI_APPLICATION = 'caracol_rojo.wsgi.application'
